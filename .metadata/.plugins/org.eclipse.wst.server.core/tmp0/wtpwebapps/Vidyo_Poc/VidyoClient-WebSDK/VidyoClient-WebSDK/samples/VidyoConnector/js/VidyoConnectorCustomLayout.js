...
function updateRenderers(vidyoConnector, fullscreen) {
    if (fullscreen) {
        ...
        $("#renderer0").css({'position': 'absolute', 'left':  '0%', 'right': '66%', 'top': '0px', 'bottom': '70%',  'width': '34%'});
        $("#renderer1").css({'position': 'absolute', 'left': '34%', 'right': '33%', 'top': '0px', 'bottom': '70%',  'width': '33%'});
        $("#renderer2").css({'position': 'absolute', 'left': '67%', 'right':  '0%', 'top': '0px', 'bottom': '70%',  'width': '33%'});
        $("#renderer3").css({'position': 'absolute', 'left':  '0%', 'right': '66%', 'top': '30%', 'bottom': '40%',  'width': '34%'});
        $("#renderer4").css({'position': 'absolute', 'left': '34%', 'right': '33%', 'top': '30%', 'bottom': '40%',  'width': '33%'});
        $("#renderer5").css({'position': 'absolute', 'left': '67%', 'right':  '0%', 'top': '30%', 'bottom': '40%',  'width': '33%'});
        $("#renderer6").css({'position': 'absolute', 'left':  '0%', 'right': '66%', 'top': '60%', 'bottom': '60px', 'width': '34%'});
        $("#renderer7").css({'position': 'absolute', 'left': '34%', 'right': '33%', 'top': '60%', 'bottom': '60px', 'width': '33%'});
        $("#renderer8").css({'position': 'absolute', 'left': '67%', 'right':  '0%', 'top': '60%', 'bottom': '60px', 'width': '33%'});
    } else {
        $("#options").removeClass("optionsHide");
